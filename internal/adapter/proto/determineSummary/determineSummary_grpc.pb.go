...
type DetermineElementaryClient interface {
	Run(ctx context.Context, in *DetermineSummryIn, opts ...grpc.CallOption) (*emptypb.Empty, error)
	WaitandGetReault(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SummaryResultRes, error)
...
func (c *determineElementaryClient) Run(ctx context.Context, in *DetermineSummryIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *determineElementaryClient) WaitandGetReault(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SummaryResultRes, error) {
	out := new(SummaryResultRes)
...
type DetermineElementaryServer interface {
	Run(context.Context, *DetermineSummryIn) (*emptypb.Empty, error)
	WaitandGetReault(context.Context, *emptypb.Empty) (*SummaryResultRes, error)
...
func (UnimplementedDetermineElementaryServer) Run(context.Context, *DetermineSummryIn) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Run not implemented")
}
func (UnimplementedDetermineElementaryServer) WaitandGetReault(context.Context, *emptypb.Empty) (*SummaryResultRes, error) {
...
func _DetermineElementary_Run_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DetermineElementaryServer).Run(ctx, req.(*DetermineSummryIn))
	}
...
var DetermineElementary_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/adapter/proto/determineSummary.proto",
}
